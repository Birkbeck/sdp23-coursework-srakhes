...
class DivInstructionTest {
  ...
  @Nested
  @DisplayName("Test of Valid inputs to the Class DivInstruction and execution of execute() method")
  class ValidDivisionTests {
...
//    @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
    ...
    void validDivisionTestFour() {
      registers.set(EAX, -500);
      registers.set(EBX, 6);
      Instruction instruction = new DivInstruction(null, EAX, EBX);
      instruction.execute(machine);
      Assertions.assertEquals(-83, machine.getRegisters().get(EAX));
    }

    @Test
//    @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
    @DisplayName("Test 5 - A positive and negative integer stored in registers EAX and EBX")
    void validDivisionTestFive() {
      registers.set(EAX, 123);
      registers.set(EBX, -6);
      Instruction instruction = new DivInstruction(null, EAX, EBX);
      instruction.execute(machine);
...
//    @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
    ...
    void validDivisionTestSix() {
      registers.set(EAX, 532);
      registers.set(EBX, 0);
      Instruction instruction = new DivInstruction(null, EAX, EBX);
      Assertions.assertThrows(ArithmeticException.class, () -> instruction.execute(machine));
//      https://junit.org/junit5/docs/current/user-guide/#extensions-exception-handling
...
//    @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
  ...
  @Nested
  @DisplayName("Test of Valid equal inputs to the Class DivInstruction and execution of overridden equals() method")
  class ValidEqualsTests {

    @Nested
    @DisplayName("Test of Reflexivity (Against the same instances of DivInstruction) for the overridden equals() method")
...
//      @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
    ...
    @Nested
    @DisplayName("Test of Symmetry (Against two separate but identical instances of DivInstruction) for the overridden equals() method")
...
//      @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
    ...
    @Nested
    @DisplayName("Test of Transitivity (Against three separate but identical instances of DivInstruction) for the overridden equals() method")
...
//      @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
      ...
      void validTransitiveEquals() {
        ...
        Instruction instruction = new DivInstruction(null, EAX, EBX);
        Instruction instructionTwo = new DivInstruction(null, EAX, EBX);
        Instruction instructionThree = new DivInstruction(null, EAX, EBX);
        Assertions.assertEquals(instruction, instructionTwo);
...
//      @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
    ...
    @Nested
    @DisplayName("Test that DivInstruction not equal to null for the overridden equals() method")
...
//      @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
  ...
  @Nested
  @DisplayName("Test of Valid Unequal inputs to the Class DivInstruction and execution of overridden equals() method")
...
//      @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
    ...
    void validSymmetricUnequal() {
      ...
      Instruction instructionTwo = new DivInstruction(null, EBX, EBX);
...
//      @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
  ...
  @Nested
  @DisplayName("Test of Reflexivity, Symmetry and Transitivity (Against three separate but identical instances of DivInstruction) for the overridden hashCode() method")
  class ValidHashCodeTests {

    @Nested
    @DisplayName("Test of the overridden hashCode() method where DivInstructions are equal")
...
//      @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
    ...
    @Nested
    @DisplayName("Test of the overridden hashCode() method where DivInstructions are not equal")
...
//      @RepeatedTest(100) // Repeat the test multiple times to test for consistency - comment out @Test if using
      ...
      void validHashCodeNotEquals() {
        ...
        Instruction instruction = new DivInstruction(null, EAX, EAX);
        Instruction instructionTwo = new DivInstruction(null, EAX, EBX);
        Instruction instructionThree = new DivInstruction(null, EBX, EAX);
        // Symmetry
        Assertions.assertNotEquals(instruction, instructionTwo);
        Assertions.assertNotEquals(instructionTwo, instruction);
